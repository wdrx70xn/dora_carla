extern "C" {
#include "/home/nano/disk/dora_project/dora/apis/c/node/node_api.h"
#include "/home/nano/disk/dora_project/dora/apis/c/operator/operator_api.h"
#include "/home/nano/disk/dora_project/dora/apis/c/operator/operator_types.h"
}
...
int run(void * dora_context)
{
    ...
    if (ty == DoraEventType_Input) {
        FILE * file = fopen("sensing/gnss_poser/zuobiao.txt", "r");
        if (file == NULL) {
