...
void Current_Pose_callback(void *dora_context, char *msg)
{
    ...
    if(cut == 1)
    {
        ...
        std::cout << "cur_pose_all.theta: " << cur_pose_all.theta << std::endl;
        std::cout << "cur_pose_all.x: " << cur_pose_all.x << std::endl;
        std::cout << "cur_pose_all.y: " << cur_pose_all.y << std::endl;
        std::cout << "cur_pose_all.s: " << cur_pose_all.s << std::endl;
        std::cout << "cur_pose_all.d: " << cur_pose_all.d << std::endl;

        // std::cout << "x: " << cur_pose_all.x << " y: " << cur_pose_all.y << " theta: "<< cur_pose_all.theta 
        // << " s: " << cur_pose_all.s << std::endl;
...
int run(void *dora_context)
{
    ...
    while (true)
    {
        ...
        if (ty == DoraEventType_Input)
        {
            ...
            if (strncmp("DoraGnssPose", data_id, 12) == 0)
            {
